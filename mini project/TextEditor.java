...
public class TextEditor extends JFrame implements ActionListener {
    ...
    TextEditor() {
        ...
        this.setTitle("Aagya's Text Editor");
        ...
        textArea.setFont(new Font("Arial", Font.PLAIN, 20)); // Default font size set to 20
        ...
        fontSizeSpinner.setValue(20); // Default value set to 20
